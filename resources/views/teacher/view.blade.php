    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="main-body">               
                        <a href="{{ route('teachers.index') }}" class="btn btn-danger text-light mb-4">Back</a>     
                        <div class="row gutters-sm">
                            <div class="col-md-4 mb-3">
                                <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ url('uploads/teacher/'.$teacher->image) }}" alt="Admin" class="rounded-circle" width="150">
                                    <div class="mt-3">
                                        <h4>{{$teacher->name_en}}</h4>
                                        <p class="text-secondary mb-1">{{$teacher->noted}}</p>

                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-body">
                                <h5 class="text-center text-primary mb-4" style="text-transform: uppercase;">Students Registration Form</h5>
                                ...
                                @csrf
                                    ...
                                    <div class="col-12 mt-3">
                                        <button type="submit" class="btn btn-primary float-right">Register Now</button>
                                    </div>
                                </form>
